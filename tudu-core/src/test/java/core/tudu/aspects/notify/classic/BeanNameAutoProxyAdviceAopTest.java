...
/**
 * Uses directly the advice instead of an advisor.
 * @author Arnaud Cogoluegnes
 *
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations={
		"/tudu/aspects/notify/classic/beanname-autoproxy-advice-context.xml"
})
public class BeanNameAutoProxyAdviceAopTest {
	...
	@Test @DirtiesContext public void count() throws Exception {
		...
		this.userService.createUser(null);
		Assert.assertEquals(3, this.notifier.getCount());
	}
