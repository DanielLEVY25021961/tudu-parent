...
@ContextConfiguration(locations={
		"/tudu/aspects/notify/aspectj/aspectj-annotation-after-throwing-context.xml"
})
public class AspectJAnnotationAfterThrowingAdviceTest {
	...
	@Test @DirtiesContext public void count() throws Exception {
		...
		this.userManager.disableUser(null);
		Assert.assertEquals(1, this.notifier.getCount());
		
		this.userManager.createUser(new User());
		Assert.assertEquals(1, this.notifier.getCount());
